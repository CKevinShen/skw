...
def main():
    ...
    if not args.evaluate:
        sys.stdout = Logger(osp.join(args.save_dir, 'log_train_cent.txt'))
    else:
        sys.stdout = Logger(osp.join(args.save_dir, 'log_test_cent.txt'))
    print("==========\nArgs:{}\n==========".format(args))
    ...
    if args.resume:
        ...
        optimizer_cent.load_state_dict(checkpoint['optimizer_cent_state_dict'])
    ...
    for epoch in range(start_epoch, args.max_epoch):
        ...
        if (epoch + 1) % 5 == 0:
            ...
            save_checkpoint = {
                ...
                'optimizer_cent_state_dict':optimizer_cent.state_dict(),
                'epoch': epoch,
            }
            torch.save(save_checkpoint, 'checkpoint_cent.pth')
        ...
        if (epoch+1) > args.start_eval and args.eval_step > 0 and (epoch+1) % args.eval_step == 0 or (epoch+1) == args.max_epoch:
            ...
            save_checkpoint({
                ...
                'rank1': rank1,
                'epoch': epoch,
            }, is_best, osp.join(args.save_dir, 'checkpoint_best_cent.pth.tar'))
